...
%do ii= 1 %to 1 ;
	...
	%let output_var= data_v2.vs_&start._&end._&category._all ;
	%selection ;
...
%do ii= 2 %to &nobs ;
	%let skunumber= &&sku_for_modelling&ii ; 
	%let catstring_in_use= &&catstring_&skunumber   ;
	%let output_var= data_v2.vs_&category._&skunumber ;
	%selection ;

	data data_v2.vs_&start._&end._&category._all ;
		merge data_v2.vs_&start._&end._&category._all data_v2.vs_&category._&skunumber ;
	run ;
	proc delete data= data_v2.vs_&category._&skunumber ;
	run ;
%end ;
%mend ;
...
/* check */
%obsnvars(data_v2.vs_&start._&end._&category._all) ;
