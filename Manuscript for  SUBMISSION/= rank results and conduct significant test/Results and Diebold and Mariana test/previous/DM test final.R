...
dm.test(e1,e2,h=8,power=1)     
dm.test(e2,e3,h=8,power=1)

dm.test(e2,e4,h=8,power=1)
dm.test(e2,e5,h=8,power=1)

dm.test(e3,e6,h=8,power=1)
dm.test(e3,e7,h=8,power=1)
dm.test(e3,e8,h=8,power=1)#### issue
