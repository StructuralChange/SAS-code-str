...
%macro calculate_mape ;
	...
	%let skunumber= &&results_sku&cc1 ;
				data temp ;
					...
					if promoall_&skunumber = 1 ;  if horizon> &horizon then delete ;
					  run ;
				...
				data temp_check_h&horizon._pro ;
					set   temp ;
				run ;
	...
	%let skunumber= &&results_sku&cc1 ;
				...
				data temp_check_h&horizon._pro ;
					set temp_check_h&horizon._pro temp ;
				run ;
...
%macro calculate_RMSE  ;
	...
	%let skunumber= &&results_sku&cc1 ;
				data temp ;
					set &results_lib..Cat_&category._sku&skunumber ;
					  ;  if promoall_&skunumber = 1 ;  */ non-promo*/ ;
