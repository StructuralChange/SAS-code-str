 ...
 *proc printto log='Q:\= IRI data research\vsm1.log' print='Q:\= IRI data research\vsm2.list' new;
run;
...
the retained results are stored in library data_v2n
...
%macro implement_sub (category) ;
	...
	%include "Q:\= IRI data research\== IRI code 5 VSM 2n\code_5.1.sas" ;
%mend ;
