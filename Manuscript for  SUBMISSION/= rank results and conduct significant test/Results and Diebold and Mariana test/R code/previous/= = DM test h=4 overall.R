...
pvalue_12<- unlist(dm.test(se1,se2,h=horizon_parm,power=1)[4],use.names=FALSE)  
pvalue_23<- unlist(dm.test(se2,se3,h=horizon_parm,power=1)[4],use.names=FALSE) 

pvalue_24<- unlist(dm.test(se2,se4,h=horizon_parm,power=1)[4],use.names=FALSE) 
pvalue_25<- unlist(dm.test(se2,se5,h=horizon_parm,power=1)[4],use.names=FALSE) 

pvalue_36<- unlist(dm.test(se3,se6,h=horizon_parm,power=1)[4],use.names=FALSE) 
pvalue_37<- unlist(dm.test(se3,se7,h=horizon_parm,power=1)[4],use.names=FALSE) 
pvalue_38<- unlist(dm.test(se3,se8,h=horizon_parm,power=1)[4],use.names=FALSE) 


pvalue_mse <- rbind(pvalue_12,pvalue_23,pvalue_24,pvalue_25,pvalue_36,pvalue_37,pvalue_38)
...
#8, ewc_ic relative to own2
  ...
  all_test_pvalue <- cbind(pvalue_mae,pvalue_smape,pvalue_mase,pvalue_mse)
