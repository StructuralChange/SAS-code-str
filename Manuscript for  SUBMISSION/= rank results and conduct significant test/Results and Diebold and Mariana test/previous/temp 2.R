...
dm.test(e1,e2,h=12,power=1)     
dm.test(e2,e3,h=12,power=1)

dm.test(e2,e4,h=12,power=1)
dm.test(e2,e5,h=12,power=1)

dm.test(e3,e6,h=12,power=1)
dm.test(e3,e7,h=12,power=1)
dm.test(e3,e8,h=12,power=1)#### issue
...
#2. test for MASE 
      e1  <- unlist(c(overall_r_own2_versus_r_base["q_0"]), use.names=FALSE)   #1 base
      e2  <- unlist(c(overall_r_own2_versus_r_base["q_1"]), use.names=FALSE)   #2 own2
...
#5. test for MSE 
      ...
      dm.test(e1,e2,h=12,power=2)     
      dm.test(e2,e3,h=12,power=2)
      
      dm.test(e2,e4,h=12,power=2)
      dm.test(e2,e5,h=12,power=2)
      
      dm.test(e3,e6,h=12,power=2)
      dm.test(e3,e7,h=12,power=2)
      dm.test(e3,e8,h=12,power=2)#### issue
