...
%macro calculate1_initial (j) ;
	...
	data temp0 ;
		...
		mpe= (2*ae)/(actual+ forecast) ;
		&limit_horizon ;if promoall_&j = 1 ;/*  promoted */ ;
...
%mend ;
 ...
 %include "Q:\= IRI data research\== IRI code findings\fixed\Forecasting period promoted\code SKU list.sas" ;
