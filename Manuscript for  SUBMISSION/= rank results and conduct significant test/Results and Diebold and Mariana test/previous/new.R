...
dm.test(rel_1,rel_2,h=horizon_parm,power=1)  
dm.test(rel_2,rel_3,h=horizon_parm,power=1)

dm.test(rel_2,rel_4,h=horizon_parm,power=1)
dm.test(rel_2,rel_5,h=horizon_parm,power=1)

dm.test(rel_3,rel_6,h=horizon_parm,power=1)
dm.test(rel_3,rel_7,h=horizon_parm,power=1)
dm.test(rel_3,rel_8,h=horizon_parm,power=1)#### issue
