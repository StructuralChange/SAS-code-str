...
%macro loopall (category, store)  ;
	%include 'Q:\= IRI data research\== IRI code 2 data coding\code 2.1_restructuring the data.sas' ;run ;
	%include 'Q:\= IRI data research\== IRI code 2 data coding\code 2.2_select valid SKUs and data imputation.sas' ;run ;
	%include 'Q:\= IRI data research\== IRI code 2 data coding\code 2.3_pre processing data.sas' ;run ;
	%include 'Q:\= IRI data research\== IRI code 2 data coding\code 2.4_construct complete variable set.sas' ;run ;
%mend ;
...
/* here we choose the stores with median size */
