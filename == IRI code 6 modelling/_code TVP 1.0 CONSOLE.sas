...
%macro run_candidate_model   ;
	%do cc= 1 %to &nobs ;
		...
		/* %let skunumber= 839 ;*/
		%put &skunumber  ;
		%include "Q:\= IRI data research\== IRI code 6 modelling\_code TVP 1.1 model.sas" ;
	%end ;
%mend ;
...
%macro conduct_all_category ;
	%include "Q:\= IRI data research\== IRI code 6 modelling\CONSOLE_model_category_string_tvp.sas" ;
%mend ;
