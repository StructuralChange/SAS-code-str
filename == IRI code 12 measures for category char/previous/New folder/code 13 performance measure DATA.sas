...
data _&measure._&horizon ;
	set rank_0.All_comparison_&horizon._&measure ;
...
data _reg_&measure._&horizon ;
	...
	by category sku ;
run ;
data expl_cat._reg_&measure.2_&horizon ;
...
%performance_model(smape, 12) ;
%performance_model(mape,  12) ;
%performance_model(mase,  12) ;

%performance_model(smape, 4) ;
%performance_model(mape,  4) ;
%performance_model(mase,  4) ;

%performance_model(smape, 1) ;
%performance_model(mape,  1) ;
