...
%macro comparison_ew   ;
	...
	%let skunumber= &&results_sku&cc1 ;
			...
			proc sort data= &lib0..Cat_&category._sku&skunumber ;
				by start horizon ;
 			proc sort data= &lib1..Cat_&category._sku&skunumber ;
				by start horizon ;
...
%mend ;
 ...
 %macro concatenate2_0 (category) ;
  %extract_sku_numbers ; 
	...
	data overall_&lib0._versus_&lib1 ;
...
%mend ;
  ...
  %extract_sku_numbers ; %comparison_ew  ;
	...
	data overall_&lib0._versus_&lib1 ;
		set overall_&lib0._versus_&lib1 temp0_all_&category ;
	run ;
...
data test ;
	set Overall_r_adl4_versus_r_ad4_ic ;
