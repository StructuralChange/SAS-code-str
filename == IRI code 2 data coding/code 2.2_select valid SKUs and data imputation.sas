...
we base on the time period from week 1114 to 1321 (208 weeks in total), so we need to 
	retain the data from week 1114 to 1321 (some selected stores have data beyond 1321.
...
data data1.valid_picture_&category ; * output, showing the quality of the dataset for this category ;
	set temp_all ;
run ;
/* 
