...
%produce1( &horizon, &model, &benchmark ,mustketc,37,&number);
...
run ;
/*
proc delete data= All_bchmk ;
proc delete data=All_candidate ;
proc delete data=Bchmk_1_38;
proc delete data=Bchmk_1_38_mae;
proc delete data=Candidate_1_38;
proc delete data=Candidate_1_38_mae;
proc delete data=Comparison;
proc delete data=Results;
proc delete data=Results2 ;
run ;
*/ 
