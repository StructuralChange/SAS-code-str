...
*/
data aa ;
	set expl_str.str_bk_&model0._versus_&model1 ;
...
%sig0(r_base, r_own2, mape) ;
%sig1(r_base, r_adl4, mape) ;
%sig1(r_base, r_ow2_ew, mape) ;
%sig1(r_base, r_ad4_ew, mape) ;
%sig1(r_base, r_ow2_ic, mape) ;
%sig1(r_base, r_ad4_ic, mape) ;

 
%sig1(r_own2, r_adl4, mape) ;
%sig1(r_own2, r_ow2_ew, mape) ;
%sig1(r_own2, r_ad4_ew, mape) ;
%sig1(r_own2, r_ow2_ic, mape) ;
%sig1(r_own2, r_ad4_ic, mape) ;

 
%sig1(r_adl4, r_ow2_ew, mape) ;
%sig1(r_adl4, r_ad4_ew, mape) ;
%sig1(r_adl4, r_ow2_ic, mape) ;
%sig1(r_adl4, r_ad4_ic, mape) ;

 
%sig1(r_ow2_ew, r_ad4_ew, mape) ;
%sig1(r_ow2_ew, r_ow2_ic, mape) ;
%sig1(r_ow2_ew, r_ad4_ic, mape) ;

%sig1(r_ad4_ew, r_ow2_ic, mape) ;
%sig1(r_ad4_ew, r_ad4_ic, mape) ;

%sig1(r_ow2_ic, r_ad4_ic, mape) ;
