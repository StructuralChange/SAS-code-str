...
ALSO, we then add the price, feature, and display of the FOCAL product BACK INTO the retained results,
...
%macro implement_sub (category) ;
	...
	%include "Q:\= IRI data research\== IRI code 5 VSM 1\code_5.1.sas" ;
