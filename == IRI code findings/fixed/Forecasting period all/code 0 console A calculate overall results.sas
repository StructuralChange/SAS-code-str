...
%macro executeall ( model ) ;
	...
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1.1 calculate MAE.sas" ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1b calculate measure for each category.sas" ;
...
%macro executeall ( model ) ;
	%let lib= &rolling._&model ;
	%let destinated1= rank_2.all_&measure._&model ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1.2 calculate MAPE.sas" ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1b calculate measure for each category.sas" ;
%mend ;
...
%macro executeall ( model ) ;
	%let lib= &rolling._&model ;
	%let destinated1= rank_2.all_&measure._&model ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1.3 calculate SMAPE.sas" ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1b calculate measure for each category.sas" ;
%mend ;
...
%macro executeall ( model ) ;
	%let lib= &rolling._&model ;
	%let destinated1= rank_2.all_&measure._&model ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1.5 calculate MPE.sas" ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1b calculate measure for each category.sas" ;
%mend ;
...
%macro executeall ( model ) ;
	%let lib= &rolling._&model ;
	%let destinated1= rank_2.all_&measure._&model ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1.4 calculate MASE.sas"  ;
	%include " Q:\= IRI data research\== IRI code findings\fixed\Forecasting period all\code 1b calculate measure for each category.sas" ;
%mend ;
